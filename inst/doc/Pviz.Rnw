...
<<ATrack-example, fig=TRUE, height=1.5>>=
...
<<DTrack-example, fig=TRUE, height=4>>=
data(PvizVignette)
...
<<ProteinAxisTrack-basic, fig=TRUE, height=1.1>>=
...
<<ProteinAxisTrack-options, fig=TRUE, height=1.1>>=
...
<<ProteinSequenceTrack-basic, fig=TRUE, height=1.5>>=
seqEx
...
<<ProteinSequenceTrack-unreadable, fig=TRUE, height=1.5>>=
...
<<ProbeTrack-basic, fig=TRUE, width=9, height=4.5>>=
...
<<ProbeTrack-wide-ranges, fig=TRUE, width=9, height=4.5>>=
plotTracks(pt)
@
...
<<ProbeTrack-legend, fig=TRUE, width=9, height=4.5>>=
...
created.
<<complex-plot, fig=TRUE, width=9, height=6>>=
